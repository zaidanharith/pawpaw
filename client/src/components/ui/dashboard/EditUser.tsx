        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-3xl w-full max-w-2xl mx-4 shadow-lg">
                <div className="p-6 border-b border-gray-100 rounded-t-2xl flex justify-between items-center"
                    ...
                    style={{ color: textColor }}>Edit User</h2>
                    <button 
                        onClick={onClose} 
                        className="text-gray-400 hover:opacity-80 transition text-2xl cursor-pointer"
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            required
                            className="w-full border border-gray-300 rounded-lg p-2.5 bg-white focus:ring-2 focus:outline-none"
                            style={{ "--tw-ring-color": accentColor } as React.CSSProperties}
                        >
