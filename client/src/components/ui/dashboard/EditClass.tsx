        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl w-full max-w-lg mx-4 shadow-lg">
                <div className="p-6 border-b rounded-t-2xl border-gray-100 flex justify-between items-center"
                    ...
                    style={{ color: textColor }}>Edit Kelas</h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        <button
                            type="button"
                            onClick={onClose}
                            className="px-4 py-2 rounded-lg border border-gray-300 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer transition"
                        >
                            Batal
                        </button>
