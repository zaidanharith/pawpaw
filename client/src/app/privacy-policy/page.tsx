    ...
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>
          ...
          <a href="https://kidconnect.vercel.app" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">
      ...
      <p>
        ...
        <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">
          TermsFeed website
        </a>{" "}
        article.
      </p>
      ...
      <h3 className="font-semibold mt-4 mb-2">Use of Your Personal Data</h3>
      ...
      <h3 className="font-semibold mt-4 mb-2">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-semibold mt-4 mb-2">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-semibold mt-4 mb-2">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-semibold mt-4 mb-2">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="font-semibold mt-4 mb-2">Security of Your Personal Data</h3>
      <p>
